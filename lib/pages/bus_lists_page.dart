...
class _BusListsState extends State<BusLists> {
                          ...
                          itemBuilder: (context, i) {
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap: ()async{
                                  Navigator.pushNamed(context, AppRoutes.homePage,arguments:TripStartArguments(busId:'${res.data![i]!.busId}',userId: userId,schoolId:schoolId));
                                },
                                child: Column(
                                  children: [
                                    Row(
  ...
  void getArguments() async{
    ...
    print("BUSLISTPAGE $userId,$schoolId");
